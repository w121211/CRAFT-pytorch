r"""Source: https://github.com/eriklindernoren/PyTorch-GAN/blob/master/implementations/munit/models.py"""
...
class MultiDiscriminator(nn.Module):
    def __init__(self, in_channels=3):
        ...
        self.downsample = nn.AvgPool2d(in_channels, stride=2, padding=[
